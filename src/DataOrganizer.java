...
public class DataOrganizer implements MouseListener
{
	...
	protected int x, y;	//for placing the buttons and collection
...
//
	protected DataCollection collection;		//	To hold our items

	protected Abutton randomButton,			//	One button for a random collection
					maximumButton,			//	Two buttons
					minimumButton,			//		to check statistics
					removeButton;			//	One button to remove an item

	protected int lastX, lastY;				//	To keep the mouse location
